<?php 
    $selector = $_GET['function'] or '$';
    $scripts = explode('|',$_GET['include']);
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<!-- saved from url=(0103)http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068 -->
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" debug="true"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	
	<?php if($scripts):foreach($scripts as $key=>$val):?>
	<script type="text/javascript" src="<?php echo $val; ?>"></script>
	<?php endforeach;endif;?>
	<script type="text/javascript">
		var $ = <?php echo $selector; ?>;
...
<body>
	  ...
	  <div class="head">
   <p><a href="http://www.w3.org/"><img height="48" alt="W3C" src="w3c_home" width="72"></a>

   </p><h1 id="title">Selectors</h1>
   ...
   <dl>
    ...
    </dt><dd><a href="http://www.w3.org/TR/2005/WD-css3-selectors-20051215">
    ...
    </dt><dd class="vcard"><span class="fn">Daniel Glazman</span> (Invited Expert)</dd>

    <dd class="vcard"><a lang="tr" class="url fn" href="http://www.tantek.com/">Tantek Çelik</a> (Invited Expert)

    </dd><dd class="vcard"><a href="mailto:ian@hixie.ch" class="url fn">Ian Hickson</a> (<span class="company"><a href="http://www.google.com/">Google</a></span>)
   ...
   Copyright</a> © 2005 <a href="http://www.w3.org/"><abbr title="World Wide Web Consortium">W3C</abbr></a><sup>®</sup>
   (<a href="http://www.csail.mit.edu/"><abbr title="Massachusetts
   Institute of Technology">MIT</abbr></a>, <a href="http://www.ercim.org/"><acronym title="European Research
   Consortium for Informatics and Mathematics">ERCIM</acronym></a>, <a href="http://www.keio.ac.jp/">Keio</a>), All Rights Reserved.  W3C
  ...
  Style Sheets) is a language for describing the rendering of <acronym title="Hypertext Markup Language">HTML</acronym> and <acronym title="Extensible Markup Language">XML</acronym> documents on
  ...
  </p><p>Selectors define the following function:</p>
  ...
  language for transforming XML trees, uses this mechanism. <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsSTTS">[STTS]</a></p>
  ...
  of this technical report can be found in the <a href="http://www.w3.org/TR/">W3C technical reports index at
  http://www.w3.org/TR/.</a></em></p>

  <p>This document describes the selectors that already exist in <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsCSS1"><abbr title="CSS level 1">CSS1</abbr></a> and <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsCSS21"><abbr title="CSS level 2">CSS2</abbr></a>, and
  ...
  <p>This specification is a last call working draft for the the <a href="http://www.w3.org/Style/CSS/members">CSS Working Group</a>
  (<a href="http://mootools.net/Style/">Style Activity</a>). This
  document is a revision of the <a href="http://www.w3.org/TR/2001/CR-css3-selectors-20011113/">Candidate
  ...
  specification and return comments to the (<a href="http://lists.w3.org/Archives/Public/www-style/">archived</a>)
  public mailing list <a href="http://www.w3.org/Mail/Lists.html#www-style">www-style</a>
  ...
  </p><p>This document may be available in <a href="http://www.w3.org/Style/css3-selectors-updates/translations">translation</a>.
  ...
  version.
   ...
   <ul class="toc">
    <li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#context">1. Introduction</a>
     <ul>
      <li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#dependencies">1.1. Dependencies</a> </li>
      <li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#terminology">1.2. Terminology</a> </li>
      <li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#changesFromCSS2">1.3. Changes from CSS2</a> </li>
     </ul>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#selectors">2. Selectors</a>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#casesens">3. Case sensitivity</a>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#selector-syntax">4. Selector syntax</a>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#grouping">5. Groups of selectors</a>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#simple-selectors">6. Simple selectors</a>
     <ul class="toc">
      <li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#type-selectors">6.1. Type selectors</a>
       <ul class="toc">
        <li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#typenmsp">6.1.1. Type selectors and namespaces</a></li>
       </ul>
      </li><li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#universal-selector">6.2. Universal selector</a>
       <ul>
        <li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#univnmsp">6.2.1. Universal selector and namespaces</a></li>
       </ul>
      </li><li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#attribute-selectors">6.3. Attribute selectors</a>
       <ul class="toc">
        <li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#attribute-representation">6.3.1. Representation of attributes and attributes values</a>
        </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#attribute-substrings">6.3.2. Substring matching attribute selectors</a>
        </li><li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#attrnmsp">6.3.3. Attribute selectors and namespaces</a>
        </li><li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#def-values">6.3.4. Default attribute values in DTDs</a></li>
       </ul>
      </li><li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#class-html">6.4. Class selectors</a>
      </li><li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#id-selectors">6.5. ID selectors</a>
      </li><li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#pseudo-classes">6.6. Pseudo-classes</a>
       <ul class="toc">
        <li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#dynamic-pseudos">6.6.1. Dynamic pseudo-classes</a>
        </li><li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#target-pseudo">6.6.2. The :target pseudo-class</a>
        </li><li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#lang-pseudo">6.6.3. The :lang() pseudo-class</a>
        </li><li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#UIstates">6.6.4. UI element states pseudo-classes</a>
        </li><li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#structural-pseudos">6.6.5. Structural pseudo-classes</a>
         <ul>
          <li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#root-pseudo">:root pseudo-class</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#nth-child-pseudo">:nth-child() pseudo-class</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#nth-last-child-pseudo">:nth-last-child()</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#nth-of-type-pseudo">:nth-of-type() pseudo-class</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#nth-last-of-type-pseudo">:nth-last-of-type()</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#first-child-pseudo">:first-child pseudo-class</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#last-child-pseudo">:last-child pseudo-class</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#first-of-type-pseudo">:first-of-type pseudo-class</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#last-of-type-pseudo">:last-of-type pseudo-class</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#only-child-pseudo">:only-child pseudo-class</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#only-of-type-pseudo">:only-of-type pseudo-class</a>
          </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#empty-pseudo">:empty pseudo-class</a></li>
         </ul>
        </li><li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#negation">6.6.7. The negation pseudo-class</a></li>
       </ul>
      </li>
     </ul>
    </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#pseudo-elements">7. Pseudo-elements</a>
     <ul>
      <li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#first-line">7.1. The ::first-line pseudo-element</a>
      </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#first-letter">7.2. The ::first-letter pseudo-element</a>
      </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#UIfragments">7.3. The ::selection pseudo-element</a>
      </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#gen-content">7.4. The ::before and ::after pseudo-elements</a></li>
     </ul>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#combinators">8. Combinators</a>
     <ul class="toc">
      <li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#descendant-combinators">8.1. Descendant combinators</a>
      </li><li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#child-combinators">8.2. Child combinators</a>
      </li><li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#sibling-combinators">8.3. Sibling combinators</a>
       <ul class="toc">
        <li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#adjacent-sibling-combinators">8.3.1. Adjacent sibling combinator</a>
        </li><li class="tocline4"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#general-sibling-combinators">8.3.2. General sibling combinator</a></li>
       </ul>
      </li>
     </ul>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#specificity">9. Calculating a selector's specificity</a>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#w3cselgrammar">10. The grammar of Selectors</a>
     <ul class="toc">
      <li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#grammar">10.1. Grammar</a>
      </li><li class="tocline3"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#lex">10.2. Lexical scanner</a></li>
     </ul>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#downlevel">11. Namespaces and down-level clients</a>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#profiling">12. Profiles</a>
    </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#Conformance">13. Conformance and requirements</a>
    </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#Tests">14. Tests</a>
    </li><li><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#ACKS">15. Acknowledgements</a>
    </li><li class="tocline2"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#references">16. References</a>
   </li></ul>
  ...
  specification, these have been described in terms of CSS2.1. <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsCSS21">[CSS21]</a></p>
  ...
  Selectors are:
   ...
   <li>a <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#general-sibling-combinators">new combinator</a> has been introduced</li>
...
<table class="selectorsReview">
  ...
  <tr>
    ...
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#universal-selector">Universal
      selector</a></td>
    <td class="origin">2</td></tr>
  <tr>
    <td class="pattern">E</td>
    <td class="meaning">an element of type E</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#type-selectors">Type selector</a></td>
    <td class="origin">1</td></tr>
  <tr>
    <td class="pattern">E[foo]</td>
    <td class="meaning">an E element with a "foo" attribute</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#attribute-selectors">Attribute
      selectors</a></td>
    <td class="origin">2</td></tr>
  <tr>
  ...
  <tr>
    ...
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#structural-pseudos">Structural
      pseudo-classes</a></td>
    <td class="origin">3</td></tr>
  <tr>
  ...
  <tr>
    ...
    (:visited)</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#link">The link
      pseudo-classes</a></td>
    <td class="origin">1</td></tr>
  <tr>
    <td class="pattern">E:active<br>E:hover<br>E:focus</td>
    <td class="meaning">an E element during certain user actions</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#useraction-pseudos">The user
  ...
  <tr>
    ...
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#target-pseudo">The target
      pseudo-class</a></td>
    <td class="origin">3</td></tr>
  <tr>
    ...
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#lang-pseudo">The :lang()
      pseudo-class</a></td>
    <td class="origin">2</td></tr>
  <tr>
    ...
    disabled</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#UIstates">The UI element states
      pseudo-classes</a></td>
    <td class="origin">3</td></tr>
  <tr>
  ...
  <tr>
    ...
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#first-line">The ::first-line
      pseudo-element</a></td>
    <td class="origin">1</td></tr>
  <tr>
    <td class="pattern">E::first-letter</td>
    <td class="meaning">the first formatted letter of an E element</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#first-letter">The ::first-letter
      pseudo-element</a></td>
    <td class="origin">1</td></tr>
  <tr>
    ...
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#UIfragments">The UI element
      fragments pseudo-elements</a></td>
    <td class="origin">3</td></tr>
  <tr>
    <td class="pattern">E::before</td>
    <td class="meaning">generated content before an E element</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#gen-content">The ::before
      pseudo-element</a></td>
    <td class="origin">2</td></tr>
  <tr>
    <td class="pattern">E::after</td>
    <td class="meaning">generated content after an E element</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#gen-content">The ::after
      pseudo-element</a></td>
    <td class="origin">2</td></tr>
  <tr>
...
"warning" (the document language specifies how class is determined).</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#class-html">Class
    selectors</a></td>
    <td class="origin">1</td></tr>
  <tr>
    <td class="pattern">E#myid</td>
    <td class="meaning">an E element with ID equal to "myid".</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#id-selectors">ID
    selectors</a></td>
    <td class="origin">1</td></tr>
  <tr>
    <td class="pattern">E:not(s)</td>
    <td class="meaning">an E element that does not match simple selector s</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#negation">Negation
      pseudo-class</a></td>
    <td class="origin">3</td></tr>
  <tr>
    <td class="pattern">E F</td>
    <td class="meaning">an F element descendant of an E element</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#descendant-combinators">Descendant
      combinator</a></td>
    <td class="origin">1</td></tr>
  <tr>
    <td class="pattern">E &gt; F</td>
    <td class="meaning">an F element child of an E element</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#child-combinators">Child
      combinator</a></td>
    <td class="origin">2</td></tr>
  <tr>
    <td class="pattern">E + F</td>
    <td class="meaning">an F element immediately preceded by an E element</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#adjacent-sibling-combinators">Adjacent sibling combinator</a></td>
    <td class="origin">2</td></tr>
  <tr>
    <td class="pattern">E ~ F</td>
    <td class="meaning">an F element preceded by an E element</td>
    <td class="described"><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#general-sibling-combinators">General sibling combinator</a></td>
...
or more <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#sequence">sequences of simple selectors</a>
separated by <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#combinators">combinators</a>.</p>

<p>A <dfn><a name="sequence">sequence of simple selectors</a></dfn>
is a chain of <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#simple-selectors-dfn">simple selectors</a>
that are not separated by a <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#combinators">combinator</a>. It
always begins with a <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#type-selectors">type selector</a> or a
<a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#universal-selector">universal selector</a>. No other type
selector or universal selector is allowed in the sequence.</p>

<p>A <dfn><a name="simple-selectors-dfn"></a><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#simple-selectors">simple selector</a></dfn> is either a <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#type-selectors">type selector</a>, <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#universal-selector">universal selector</a>, <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#attribute-selectors">attribute selector</a>, <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#class-html">class selector</a>, <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#id-selectors">ID selector</a>, <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#content-selectors">content selector</a>, or <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#pseudo-classes">pseudo-class</a>. One <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#pseudo-elements">pseudo-element</a> may be appended to the last
...
no pseudo-element, is an <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#Conformance">invalid
selector</a>.</p>
...
<p>Type selectors allow an optional namespace (<a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsXMLNAMES">[XMLNAMES]</a>) component. A namespace prefix
...
previously declared is an <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#Conformance">invalid</a> selector.
...
against the <a href="http://www.w3.org/TR/REC-xml-names/#NT-LocalPart">local part</a>
of the element's <a href="http://www.w3.org/TR/REC-xml-names/#ns-qualnames">qualified
name</a>. See <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#downlevel">below</a> for notes about matching
...
specified, see <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#univnmsp">Universal selector and
...
been previously declared is an <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#Conformance">invalid</a>
...
<dl>
  <dt><code>[att]</code>
  </dt><dd>Represents an element with the <code>att</code> attribute, whatever the value of
  the attribute.</dd>
  <dt><code>[att=val]</code></dt>
  <dd>Represents an element with the <code>att</code> attribute whose value is exactly
  "val".</dd>
  <dt><code>[att~=val]</code></dt>
  <dd>Represents an element with the <code>att</code> attribute whose value is a <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#whitespace">whitespace</a>-separated list of words, one of
  ...
  </dt><dd>Represents an element with the <code>att</code> attribute, its value either
  ...
  <code>link</code> element in HTML) as described in RFC 3066 (<a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsRFC3066">[RFC3066]</a>).  For <code>lang</code> (or
  <code>xml:lang</code>) language subcode matching, please see <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#lang-pseudo">the <code>:lang</code> pseudo-class</a>.</dd>
</dl>
...
<dl>
  ...
  <dt><code>[att$=val]</code>
  </dt><dd>Represents an element with the <code>att</code> attribute whose value ends with
  the suffix "val".</dd>
  <dt><code>[att*=val]</code>
  </dt><dd>Represents an element with the <code>att</code> attribute whose value contains
...
prefix that has not been previously declared is an <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#Conformance">invalid</a> selector.  The mechanism for declaring
...
attribute values in the document's "internal subset." (See <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsXML10">[XML10]</a> for definitions of these subsets.)</p>

<p>A UA that recognizes an XML namespace <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsXMLNAMES">[XMLNAMES]</a> is not required to use its
...
1.0 <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsSVG">[SVG]</a> describes the <a href="http://www.w3.org/TR/2001/PR-SVG-20010719/styling.html#ClassAttribute">SVG
"class" attribute</a> and how a UA should interpret it, and
similarly MathML 1.01 <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsMATH">[MATH]</a> describes the <a href="http://www.w3.org/1999/07/REC-MathML-19990707/chapter2.html#sec2.3.4">MathML
"class" attribute</a>.)</p>
...
<div class="example">
  ...
  has been assigned a list of <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#whitespace">whitespace</a>-separated values that includes
...
<p class="note"><strong>Note.</strong> In XML 1.0 <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsXML10">[XML10]</a>, the information about which attribute
...
</p><p>UAs may therefore treat all links as unvisited links, or implement
...
<ul>
  ...
  element. User agents not that do not support <a href="http://www.w3.org/TR/REC-CSS2/media.html#interactive-media-group">interactive
  media</a> do not have to support this pseudo-class. Some conforming
  user agents that support <a href="http://www.w3.org/TR/REC-CSS2/media.html#interactive-media-group">interactive
...
represent an element based on its language. For example, in HTML <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsHTML4">[HTML4]</a>, the language is determined by a
...
element's language value, in the same way as if performed by the <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#attribute-representation">'|='</a> operator in attribute
...
documents and protocols indicate language using codes from RFC 3066 <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsRFC3066">[RFC3066]</a> or its successor, and by means of
"xml:lang" attributes in the case of XML-based documents <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsXML10">[XML10]</a>. See <a href="http://www.w3.org/International/questions/qa-lang-2or3.html">
...
attributes as described in <a href="http://www.w3.org/TR/REC-html40/interact/forms.html#h-17.2.1">Section
...
</p><p>Note that standalone pieces of PCDATA (text nodes in the DOM) are
...
</p><p>In addition to this, <code>:nth-child()</code> can take
...
functional notation taking a <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#simple-selectors-dfn">simple
...
<a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#subject">subjects</a> of the selector. <span class="note">A
...
</p><p class="note">Note that the first line of the <code>p</code> in this
...
be included. <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsUNICODE">[UNICODE]</a></p>
...
</p><p>The first letter must occur on the <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#first-formatted-line">first formatted line.</a> For example, in
...
</p><p>In CSS, if an element is a list item ('display: list-item'), the
...
</p><p>If the letters that would form the ::first-letter are not in the
...
field. This pseudo-element should not be confused with the <code><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#checked">:checked</a></code> pseudo-class (which used to be
named <code>:selected</code>)

</p><p>Although the <code>::selection</code> pseudo-element is dynamic in
...
<a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsCSS21">[CSS21]</a>) which was originally rendered to a
...
content. They are explained in CSS 2.1 <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsCSS21">[CSS21]</a>.</p>
...
descendant combinator is <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#whitespace">white space</a> that
...
is &lt;em&gt;very&lt;/em&gt; important&lt;/span&gt;&lt;/h1&gt;</pre>
 ...
 <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#attribute-selectors">attribute selectors</a>, represents an
...
see the section on the <code><a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#structural-pseudos">:first-child</a></code> pseudo-class
above.</p>
...
<p>Selectors inside <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#negation">the negation pseudo-class</a>
...
2.1. <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsCSS21">[CSS21]</a>.</p>
...
shorthand notations beyond Yacc (see <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsYACC">[YACC]</a>)
are used:</p>
...
<a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsFLEX">[FLEX]</a>) notation. The tokenizer is
case-insensitive.</p>
...
possible code point in Unicode/ISO-10646. <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#refsUNICODE">[UNICODE]</a></p>
...
<ol>
  ...
  <li>
   ...
   <ul>
    ...
    qualified name, not the local part as outlined in the <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#typenmsp">Type selectors and Namespaces</a> section. CSS
...
</p><p>All specifications reusing Selectors must contain a <a href="http://mootools.net/slickspeed/system/template.php?include=jquery1.5.1.js&function=$&nocache=1367387068#profiling">Profile</a> listing the
...
<dl class="refs">
  ...
  <dt>[CSS1]
  </dt><dd><a name="refsCSS1"></a> Bert Bos, Håkon Wium Lie; "<cite>Cascading Style Sheets, level 1</cite>", W3C Recommendation, 17 Dec 1996, revised 11 Jan 1999
  </dd><dd>(<code><a href="http://www.w3.org/TR/REC-CSS1">http://www.w3.org/TR/REC-CSS1</a></code>)

  </dd><dt>[CSS21]
  </dt><dd><a name="refsCSS21"></a> Bert Bos, Tantek Çelik, Ian Hickson, Håkon Wium Lie, editors; "<cite>Cascading Style Sheets, level 2 revision 1</cite>", W3C Working Draft, 13 June 2005 
  </dd><dd>(<code><a href="http://www.w3.org/TR/CSS21">http://www.w3.org/TR/CSS21</a></code>)

  </dd><dt>[CWWW]
  </dt><dd><a name="refsCWWW"></a> Martin J. Dürst, François Yergeau, Misha Wolf, Asmus Freytag, Tex Texin, editors; "<cite>Character Model for the World Wide Web</cite>", W3C Recommendation, 15 February 2005
  </dd><dd>(<code><a href="http://www.w3.org/TR/charmod/">http://www.w3.org/TR/charmod/</a></code>)

  </dd><dt>[FLEX]
  </dt><dd><a name="refsFLEX"></a> "<cite>Flex: The Lexical Scanner Generator</cite>", Version 2.3.7, ISBN 1882114213

  </dd><dt>[HTML4]
  </dt><dd><a name="refsHTML4"></a> Dave Ragget, Arnaud Le Hors, Ian Jacobs, editors; "<cite>HTML 4.01 Specification</cite>", W3C Recommendation, 24 December 1999
  </dd><dd>(<a href="http://www.w3.org/TR/html4/"><code>http://www.w3.org/TR/html4/</code></a>)

  </dd><dt>[MATH]
  </dt><dd><a name="refsMATH"></a> Patrick Ion, Robert Miner, editors; "<cite>Mathematical Markup Language (MathML) 1.01</cite>", W3C Recommendation, revision of 7 July 1999
  </dd><dd>(<code><a href="http://www.w3.org/TR/REC-MathML/">http://www.w3.org/TR/REC-MathML/</a></code>)

  </dd><dt>[RFC3066]
  </dt><dd><a name="refsRFC3066"></a> H. Alvestrand; "<cite>Tags for the Identification of Languages</cite>", Request for Comments 3066, January 2001
  </dd><dd>(<a href="http://www.ietf.org/rfc/rfc3066.txt"><code>http://www.ietf.org/rfc/rfc3066.txt</code></a>)

  </dd><dt>[STTS]
  </dt><dd><a name="refsSTTS"></a> Daniel Glazman; "<cite>Simple Tree Transformation Sheets 3</cite>", Electricité de France, submission to the W3C, 11 November 1998 
  </dd><dd>(<code><a href="http://www.w3.org/TR/NOTE-STTS3">http://www.w3.org/TR/NOTE-STTS3</a></code>)

  </dd><dt>[SVG]
  </dt><dd><a name="refsSVG"></a> Jon Ferraiolo, 藤沢 淳, Dean Jackson, editors; "<cite>Scalable Vector Graphics (SVG) 1.1 Specification</cite>", W3C Recommendation, 14 January 2003
  </dd><dd>(<code><a href="http://www.w3.org/TR/SVG/">http://www.w3.org/TR/SVG/</a></code>)

  </dd><dt>[UNICODE]</dt>
  <dd><a name="refsUNICODE"></a> <cite><a href="http://www.unicode.org/versions/Unicode4.1.0/">The Unicode Standard, Version 4.1</a></cite>, The Unicode Consortium. Boston, MA, Addison-Wesley, March 2005. ISBN 0-321-18578-1, as amended by <a href="http://www.unicode.org/versions/Unicode4.0.1/">Unicode 4.0.1</a> and <a href="http://www.unicode.org/versions/Unicode4.1.0/">Unicode  4.1.0</a>.
  </dd><dd>(<code><a href="http://www.unicode.org/versions/">http://www.unicode.org/versions/</a></code>)</dd>

  <dt>[XML10]
  </dt><dd><a name="refsXML10"></a> Tim Bray, Jean Paoli, C. M. Sperberg-McQueen, Eve Maler, François Yergeau, editors; "<cite>Extensible Markup Language (XML) 1.0 (Third Edition)</cite>", W3C Recommendation, 4 February 2004
  </dd><dd>(<a href="http://www.w3.org/TR/REC-xml/"><code>http://www.w3.org/TR/REC-xml/</code></a>)

  </dd><dt>[XMLNAMES]
  </dt><dd><a name="refsXMLNAMES"></a> Tim Bray, Dave Hollander, Andrew Layman, editors; "<cite>Namespaces in XML</cite>", W3C Recommendation, 14 January 1999
  </dd><dd>(<a href="http://www.w3.org/TR/REC-xml-names/"><code>http://www.w3.org/TR/REC-xml-names/</code></a>)

  </dd><dt>[YACC]
  </dt><dd><a name="refsYACC"></a> S. C. Johnson; "<cite>YACC — Yet another compiler compiler</cite>", Technical Report, Murray Hill, 1975
